<form method="post" action="">
    ...
    <div class="form-group">
        ...
        <input value="<?= get_post('gurdian_name') ? get_post('gurdian_name') : ($record ? $record['gurdian_name'] : ''); ?>" type="text"
            class="form-control" required id="gurdian_name" name="gurdian_name" placeholder="">
    ...
    <div class="form-group">
        ...
        <input value="<?= get_post('gurdian_contact_number') ? get_post('gurdian_contact_number') : ($record ? $record['gurdian_contact_number'] : ''); ?>" type="text"
            class="form-control" required id="gurdian_contact_number" name="gurdian_contact_number" placeholder="">
        <span class="error-message"><?= isset($errors["gurdian_contact_number"]) ? $errors["gurdian_contact_number"]: ""; ?></span>
    </div>
    <div class="form-group">
